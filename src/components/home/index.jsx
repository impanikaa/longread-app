    ...
    <div className={styles.container}>
        ...
        <div className={styles.container_description_2}>
            <div className={styles.description_text}>
                ...
                <p>Многие олимпиадники сталкиваются с тревожностью по разным поводам, и это действительно мешает брать заветные дипломы. А этом разделе опытными олимпиадниками описаны способы борьбы с 6 видами олимпиадой тревожности.</p>
